...
object AboutUtils {
    ...
    fun showWebViewDialog(activity: FragmentActivity, title: String, fileName: String, tag: String) {
        if (activity.supportFragmentManager.findFragmentByTag(tag) != null) return

        val mDialog = WebViewDialog.newInstance(title, fileName)
    ...
    fun openUrlWebBrowser(context: Context, urlStr: String) {
